...
#define sigma 0.01 //500 //snake lengths are gaussian distribution of this standard deviation
//set to a very small value to have snakes of exactly the 'average' length 

#define beta 0.03 //BETA //5 //0.01 //25.0		// B=1/T  T=temperature of the lattice, in units of k_B
...
#define SLITHER_PRINT 10000000
#define MC_BETWEEN_DROPS 100000
...
{
  {0.0, 0.0},
  {0.0, 500} //+ve energies are attractive, -ve energies are repulsive
};
